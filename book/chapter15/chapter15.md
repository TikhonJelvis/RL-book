...
![Monte-Carlo Tree-Search (Image Credit: \protect\url{https://en.wikipedia.org/wiki/Monte_Carlo_tree_search})\label{fig:mcts}](./chapter15/mcts.png "Monte-Carlo Tree-Search (Image Credit: [https://en.wikipedia.org/wiki/Monte_Carlo_tree_search](https://en.wikipedia.org/wiki/Monte_Carlo_tree_search))")
