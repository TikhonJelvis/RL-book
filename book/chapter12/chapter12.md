...
![Value Function Geometry (Image Credit: Sutton-Barto's RL Book) \label{fig:vf_geometry}](./chapter12/vf_geometry_revised.pdf "Value Function Geometry (Image Credit: Sutton-Barto's RL Book)"){height=8cm}
